...
exports.RegisterEntity = {
    ...
    create(base) {
        return exports.RegisterEntity.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
exports.RegisterEntity_AttributesEntry = {
    ...
    create(base) {
        return exports.RegisterEntity_AttributesEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseRegisterEntity_AttributesEntry();
...
exports.RegisterEntity_EntityAttribute = {
    ...
    create(base) {
        return exports.RegisterEntity_EntityAttribute.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseRegisterEntity_EntityAttribute();
...
exports.EntityUpdate = {
    ...
    create(base) {
        return exports.EntityUpdate.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseEntityUpdate();
        ...
        message.attributes = ((_d = object.attributes) === null || _d === void 0 ? void 0 : _d.map((e) => exports.RegisterEntity_EntityAttribute.fromPartial(e))) || [];
        return message;
    },
};
