...
exports.GlobalEvent = {
    ...
    fromPartial(object) {
        ...
        message.attributes = Object.entries((_g = object.attributes) !== null && _g !== void 0 ? _g : {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
...
exports.GlobalEvent_AttributesEntry = {
    ...
    create(base) {
        return exports.GlobalEvent_AttributesEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGlobalEvent_AttributesEntry();
...
exports.GlobalEvent_EventAttribute = {
    ...
    create(base) {
        return exports.GlobalEvent_EventAttribute.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseGlobalEvent_EventAttribute();
