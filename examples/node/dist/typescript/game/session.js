...
exports.Session = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.players) {
            player_1.Player.encode(v, writer.uint32(26).fork()).join();
        }
        if (message.state !== 0) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3: {
                    ...
                    message.players.push(player_1.Player.decode(reader, reader.uint32()));
                    continue;
                }
                case 4: {
                    if (tag !== 32) {
    ...
    fromJSON(object) {
        return {
            ...
            players: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.players) ? object.players.map((e) => player_1.Player.fromJSON(e)) : [],
    ...
    toJSON(message) {
        ...
        if ((_a = message.players) === null || _a === void 0 ? void 0 : _a.length) {
            obj.players = message.players.map((e) => player_1.Player.toJSON(e));
        }
        if (message.state !== 0) {
    ...
    fromPartial(object) {
        ...
        message.players = ((_c = object.players) === null || _c === void 0 ? void 0 : _c.map((e) => player_1.Player.fromPartial(e))) || [];
