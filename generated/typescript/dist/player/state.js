...
})(State_PlayerState || (State_PlayerState = {}));
export function state_PlayerStateFromJSON(object) {
    switch (object) {
        case 0:
        case "WAITING":
...
export function state_PlayerStateToJSON(object) {
    switch (object) {
...
export const State = {
    encode(message, writer = new BinaryWriter()) {
        ...
        Object.entries(message.attributes).forEach(([key, value]) => {
            State_AttributesEntry.encode({ key: key, value }, writer.uint32(42).fork()).join();
        });
...
export const State_AttributesEntry = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
    ...
    create(base) {
        return State_AttributesEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseState_AttributesEntry();
...
export const State_PlayerAttribute = {
    encode(message, writer = new BinaryWriter()) {
    ...
    create(base) {
        return State_PlayerAttribute.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseState_PlayerAttribute();
