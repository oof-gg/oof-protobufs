...
})(Action_ActionType || (Action_ActionType = {}));
export function action_ActionTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "CUSTOM":
...
export function action_ActionTypeToJSON(object) {
    switch (object) {
...
export const Action = {
    encode(message, writer = new BinaryWriter()) {
        ...
        Object.entries(message.action).forEach(([key, value]) => {
            Action_ActionEntry.encode({ key: key, value }, writer.uint32(58).fork()).join();
        });
...
export const Action_ActionEntry = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
    ...
    create(base) {
        return Action_ActionEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseAction_ActionEntry();
...
export const Action_Position = {
    ...
    create(base) {
        return Action_Position.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseAction_Position();
...
export const Action_Velocity = {
    ...
    create(base) {
        return Action_Velocity.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseAction_Velocity();
...
export const Action_PlayerAction = {
    encode(message, writer = new BinaryWriter()) {
    ...
    create(base) {
        return Action_PlayerAction.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseAction_PlayerAction();
