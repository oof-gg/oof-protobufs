...
function createBaseTrendingGamesRequest() {
    return { limit: undefined, cursor: undefined };
}
exports.TrendingGamesRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.limit !== undefined) {
    ...
    create(base) {
        return exports.TrendingGamesRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTrendingGamesRequest();
        message.limit = object.limit ?? undefined;
