...
export declare const PlayerServiceService: {
    readonly createPlayer: {
        readonly path: "/v1.api.player.PlayerService/CreatePlayer";
    ...
    readonly getPlayer: {
        readonly path: "/v1.api.player.PlayerService/GetPlayer";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly updatePlayer: {
        readonly path: "/v1.api.player.PlayerService/UpdatePlayer";
        readonly requestStream: false;
        readonly responseStream: false;
    ...
    readonly streamEvents: {
        readonly path: "/v1.api.player.PlayerService/StreamEvents";
