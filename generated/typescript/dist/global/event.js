...
export var GlobalEvent_EventType;
...
})(GlobalEvent_EventType || (GlobalEvent_EventType = {}));
export function globalEvent_EventTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "CUSTOM":
...
export function globalEvent_EventTypeToJSON(object) {
    switch (object) {
...
export const GlobalEvent = {
    encode(message, writer = new BinaryWriter()) {
        ...
        Object.entries(message.attributes).forEach(([key, value]) => {
            GlobalEvent_AttributesEntry.encode({ key: key, value }, writer.uint32(58).fork()).join();
        });
        if (message.type !== 0) {
    ...
    create(base) {
        return GlobalEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
...
export const GlobalEvent_AttributesEntry = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
    ...
    create(base) {
        return GlobalEvent_AttributesEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseGlobalEvent_AttributesEntry();
...
export const GlobalEvent_EventAttribute = {
    encode(message, writer = new BinaryWriter()) {
    ...
    create(base) {
        return GlobalEvent_EventAttribute.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseGlobalEvent_EventAttribute();
