...
func (Session_GameState) Descriptor() protoreflect.EnumDescriptor {
	return file_game_session_proto_enumTypes[0].Descriptor()
}

func (Session_GameState) Type() protoreflect.EnumType {
	return &file_game_session_proto_enumTypes[0]
}
...
func (Session_GameState) EnumDescriptor() ([]byte, []int) {
	return file_game_session_proto_rawDescGZIP(), []int{0, 0}
}
...
type Session struct {
	...
	State Session_GameState `protobuf:"varint,4,opt,name=state,proto3,enum=game.Session_GameState" json:"state,omitempty"`
...
func (x *Session) Reset() {
	*x = Session{}
	mi := &file_game_session_proto_msgTypes[0]
...
func (*Session) Descriptor() ([]byte, []int) {
	return file_game_session_proto_rawDescGZIP(), []int{0}
}
...
func (x *Session_GameAttribute) Reset() {
	*x = Session_GameAttribute{}
	mi := &file_game_session_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Session_GameAttribute) Descriptor() ([]byte, []int) {
	return file_game_session_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_game_session_proto protoreflect.FileDescriptor

var file_game_session_proto_rawDesc = []byte{
	0x0a, 0x12, 0x67, 0x61, 0x6d, 0x65, 0x2f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x67, 0x61, 0x6d, 0x65, 0x22, 0x80, 0x04, 0x0a, 0x07, 0x53,
	...
	0x03, 0x28, 0x09, 0x52, 0x09, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x64, 0x73, 0x12, 0x2d,
	0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e,
	0x67, 0x61, 0x6d, 0x65, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x47, 0x61, 0x6d,
	...
	0x0b, 0x32, 0x1d, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x52, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x1a, 0x5a, 0x0a, 0x0f,
	...
	0x32, 0x1b, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e,
	0x47, 0x61, 0x6d, 0x65, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0xa0, 0x01, 0x0a, 0x0d, 0x47, 0x61, 0x6d,
	...
	,
}

var (
	file_game_session_proto_rawDescOnce sync.Once
	file_game_session_proto_rawDescData = file_game_session_proto_rawDesc
)

func file_game_session_proto_rawDescGZIP() []byte {
	file_game_session_proto_rawDescOnce.Do(func() {
		file_game_session_proto_rawDescData = protoimpl.X.CompressGZIP(file_game_session_proto_rawDescData)
	})
	return file_game_session_proto_rawDescData
}

var file_game_session_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_game_session_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_game_session_proto_goTypes = []any{
	(Session_GameState)(0),        // 0: game.Session.GameState
	(*Session)(nil),               // 1: game.Session
	nil,                           // 2: game.Session.AttributesEntry
	(*Session_GameAttribute)(nil), // 3: game.Session.GameAttribute
}
var file_game_session_proto_depIdxs = []int32{
	0, // 0: game.Session.state:type_name -> game.Session.GameState
	2, // 1: game.Session.attributes:type_name -> game.Session.AttributesEntry
	3, // 2: game.Session.AttributesEntry.value:type_name -> game.Session.GameAttribute
...
func init() { file_game_session_proto_init() }
func file_game_session_proto_init() {
	if File_game_session_proto != nil {
		return
	}
	file_game_session_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_game_session_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_game_session_proto_goTypes,
		DependencyIndexes: file_game_session_proto_depIdxs,
		EnumInfos:         file_game_session_proto_enumTypes,
		MessageInfos:      file_game_session_proto_msgTypes,
	}.Build()
	File_game_session_proto = out.File
	file_game_session_proto_rawDesc = nil
	file_game_session_proto_goTypes = nil
	file_game_session_proto_depIdxs = nil
}
