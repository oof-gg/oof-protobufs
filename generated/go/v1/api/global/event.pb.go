...
var file_v1_api_global_event_proto_goTypes = []interface{}{
...
func file_v1_api_global_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1_api_global_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_api_global_event_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GlobalEvent_EventAttribute); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_v1_api_global_event_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_v1_api_global_event_proto_msgTypes[2].OneofWrappers = []interface{}{
