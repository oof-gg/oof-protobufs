...
var file_v1_api_game_join_leave_proto_goTypes = []interface{}{
...
func file_v1_api_game_join_leave_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1_api_game_join_leave_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JoinLeaveGame); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_v1_api_game_join_leave_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
