...
var file_v1_api_player_state_proto_goTypes = []interface{}{
...
func file_v1_api_player_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1_api_player_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*State); i {
			case 0:
				return &v.state
			case 1:
		...
		file_v1_api_player_state_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*State_PlayerAttribute); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_v1_api_player_state_proto_msgTypes[2].OneofWrappers = []interface{}{
