...
import (
	player "generated/go/v1/api/player"
...
var File_v1_api_player_player_service_proto protoreflect.FileDescriptor

var file_v1_api_player_player_service_proto_rawDesc = []byte{
	0x0a, 0x22, 0x76, 0x31, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2f,
...
var file_v1_api_player_player_service_proto_goTypes = []any{
...
var file_v1_api_player_player_service_proto_depIdxs = []int32{
...
func init() { file_v1_api_player_player_service_proto_init() }
func file_v1_api_player_player_service_proto_init() {
	if File_v1_api_player_player_service_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_v1_api_player_player_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_v1_api_player_player_service_proto_goTypes,
		DependencyIndexes: file_v1_api_player_player_service_proto_depIdxs,
	}.Build()
	File_v1_api_player_player_service_proto = out.File
	file_v1_api_player_player_service_proto_rawDesc = nil
	file_v1_api_player_player_service_proto_goTypes = nil
	file_v1_api_player_player_service_proto_depIdxs = nil
}
