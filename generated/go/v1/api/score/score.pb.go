...
type PlayerScoresRequest struct {
	...
	Offset   int32  `protobuf:"varint,4,opt,name=offset,proto3" json:"offset,omitempty"`              // for pagination
}
...
func (x *PlayerScoresRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
var file_v1_api_score_score_proto_rawDesc = []byte{
	...
	0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x9a, 0x01, 0x0a, 0x14, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72,
	...
	0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x68, 0x0a, 0x11, 0x50, 0x6c, 0x61, 0x79,
	...
	0x6c, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0x5e, 0x0a, 0x10, 0x53, 0x74, 0x61, 0x6e,
	...
	0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68,
...
var file_v1_api_score_score_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_v1_api_score_score_proto_goTypes = []interface{}{
	...
	(*StandardResponse)(nil),      // 9: v1.api.score.StandardResponse
	nil,                           // 10: v1.api.score.Score.MetadataEntry
	nil,                           // 11: v1.api.score.ScoreSubmission.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 12: google.protobuf.Timestamp
}
var file_v1_api_score_score_proto_depIdxs = []int32{
	12, // 0: v1.api.score.Score.created_at:type_name -> google.protobuf.Timestamp
	10, // 1: v1.api.score.Score.metadata:type_name -> v1.api.score.Score.MetadataEntry
	...
	12, // 5: v1.api.score.Leaderboard.last_updated:type_name -> google.protobuf.Timestamp
	11, // 6: v1.api.score.ScoreSubmission.metadata:type_name -> v1.api.score.ScoreSubmission.MetadataEntry
